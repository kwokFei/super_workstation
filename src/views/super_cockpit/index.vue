<template>
    <div class="maxBox">
        ...
        <div class="contentBox">
            ...
            <div class="listBox">
                <div class="btnBox">
                    <button @click="addTemplate">创建驾驶舱</button>
                </div>
                    ...
                    >
                        <div class="imgBox">
                            ...
                            <div class="mbBox" v-show="isMaxShow === index">
                                <el-button type="primary" plain size="mini" icon="el-icon-money" @click="goTo1110">编辑
                                </el-button>
        ...
        <div class="templateBox" v-show="isTemplate">
            <div class="mintTem">
                ...
                <div class="listUIBox">
                    <p>
                        <span>选&nbsp;择&nbsp;行&nbsp;业:</span>
                        <business-cascader style="width:3rem"
                                           @handleChangeBusiness=handleChangeBusiness></business-cascader>
                    </p>
                    <p>
                        <span>驾驶舱名称:</span>
                    ...
                    <p>
                        <span style="display:block">驾驶舱高度:</span>
                        <el-input style="width: 3rem" v-model="jscHeight"></el-input>
                    </p>
                    <p>
                        <span style="display:block">驾驶舱宽度:</span>
